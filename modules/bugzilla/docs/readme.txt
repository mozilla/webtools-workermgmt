...
0. This code utilizes the xmlrpc interface to bugzilla so
   read http://www.bugzilla.org/docs/tip/en/html/api/Bugzilla/WebService/Bug.html#Bug_Creation_and_Modification
...
4. extend Filing class (i.e classes/filing/newhire/setup.php) and do 2 things.
    ...
    2. override contruct_content() (be sure to call parent::contruct_content() in
       ...
       This is where you build any values for bug that you could not define in
